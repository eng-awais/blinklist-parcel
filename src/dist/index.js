...
})({"glYuT":[function(require,module,exports) {
...
const assignVariation = (articleId, variations)=>{
    ...
    const uniqueId = (0, _nanoid.nanoid)();
...
const determineWinningVariation = (articleId)=>{
    ...
    const ctrData = (0, _dataJsonDefault.default)[article].ctr;
...
const renderArticle = (articleId, variation)=>{
    ...
    let article = "article" + articleId;
    const articleContent = (0, _dataJsonDefault.default)[article].content;
...
const getCurrentArticleId = ()=>{
    ...
    return Math.floor(Math.random() * (Object.keys((0, _dataJsonDefault.default)).length - 1 + 1)) + 1;
};
...
(0, _analyticsApiJs.trackPageview)();
...
},{"./analytics-api.js":"gDoxF","./data.json":"aLYkf","nanoid":"2ifus","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"gDoxF":[function(require,module,exports) {
/**
...
},{"./url-alphabet/index.js":false,"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["glYuT","8lqZg"], "8lqZg", "parcelRequire99db")
